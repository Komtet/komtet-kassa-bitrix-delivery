2.8.2 (2026-09-04)
==================
  - Изменение сохранения мултиселектов в настройках плагина

2.8.1 (2026-08-13)
==================
  - Устранение минорных предупреждений по безопасности в блоке сохранения настроек плагина

2.8.0 (2026-08-12)
==================
  - В обработку отчета КомтетКассы добавлена проверка подписи
  - В обработку отчета КомтетКассы добавлено ограничение на метод запроса (только POST)
  - В обработку отчета КомтетКассы добавлены логирование в журнал событий для аудита запроса

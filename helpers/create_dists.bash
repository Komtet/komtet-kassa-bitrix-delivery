...
mkdir -p "$DIST_MARKET_DIR/$VERSION_DIR"

for element in "${DIFFS[@]}"
do
   echo -e "${YELLOW} * ${element} ${COLOR_OFF}"
   cp -r ${element} "$DIST_MARKET_DIR/$VERSION_DIR"
done
...
echo -e "${YELLOW} * ${DIST_MARKET_DIR}/${VERSION_TAR}${COLOR_OFF}"
echo -e "${YELLOW} * ${DIST_GITHUB_DIR}/${PROJECT_TAR}${COLOR_OFF}"
